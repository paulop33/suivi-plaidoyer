 ...
 */
final class Version20250909151239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commitment (id SERIAL NOT NULL, city_id INT NOT NULL, proposition_id INT NOT NULL, creation_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, update_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, comment_city TEXT DEFAULT NULL, comment_association TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_F3E0CCBB8BAC62AF ON commitment (city_id)');
        $this->addSql('CREATE INDEX IDX_F3E0CCBBDB96F9E ON commitment (proposition_id)');
        $this->addSql('CREATE TABLE contact (id SERIAL NOT NULL, city_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_4C62E6388BAC62AF ON contact (city_id)');
        $this->addSql('CREATE TABLE proposition (id SERIAL NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, bareme INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE commitment ADD CONSTRAINT FK_F3E0CCBB8BAC62AF FOREIGN KEY (city_id) REFERENCES city (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE contact ADD CONSTRAINT FK_4C62E6388BAC62AF FOREIGN KEY (city_id) REFERENCES city (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commitment DROP CONSTRAINT FK_F3E0CCBB8BAC62AF');
        $this->addSql('ALTER TABLE commitment DROP CONSTRAINT FK_F3E0CCBBDB96F9E');
        $this->addSql('ALTER TABLE contact DROP CONSTRAINT FK_4C62E6388BAC62AF');
